-- Fix: mover_cliente_atomico now clears status_follow_up when moving back to negociacao
-- and supports clearing it via p_extras
...
BEGIN
  ...
  -- 3. Limpar status_follow_up ao voltar para negociacao (cancelamento de pedido)
