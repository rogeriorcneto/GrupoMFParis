...
const mockClientes: Cliente[] = [
  { id: 1, razaoSocial: 'Empresa Alpha', cnpj: '11111111000100', contatoNome: 'Ana', contatoTelefone: '11900000001', contatoEmail: 'ana@alpha.com', etapa: 'cliente_ativo', vendedorId: 1, valorEstimado: 50000, dataEntradaEtapa: `${thisMonth}-05`, enderecoEstado: 'SP', enderecoCidade: 'São Paulo', historicoEtapas: [{ etapa: 'prospecção', data: `${thisMonth}-01` }] },
